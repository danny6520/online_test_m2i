    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="add_user.php">Add User</a></li>
...
<input type="email" name="new_user_email" class="form-control" placeholder="Enter the User Email" required />
<br />
