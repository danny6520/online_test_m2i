...
<hr>
        ...
        <tr ng-repeat="option in exam_source.options">
          ...
          <td>
            <div ng-if="exam_source.question_type == 'image'">
              <img src="{{option.answer}}" width="30%"/>
            </div>
            <div ng-if="exam_source.question_type == 'text'">
              {{option.answer}}
            </div>
  ...
  $scope.prevPage = function() {
    ...
    var request = {
      ...
      //url: 'https://m2its.com/online_test/fetch_online_test_data.php',
      url: 'http://localhost/m2its/mv2/online_test/fetch_online_test_data.php',
