...
WHERE qi.question_status = 'A' AND ai.answer_status = 'A' AND qi.fk_class_id='$_SESSION[class_id_for_fetch_exam]' AND qi.fk_subject_id='$_SESSION[subject_id_for_fetch_exam]' AND qi.fk_org_id IN (SELECT user_org_id FROM user_info WHERE user_email = '$_SESSION[login_admin_user_email]')
